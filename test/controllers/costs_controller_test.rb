...
class CostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post costs_url, params: { cost: { description: @cost.description, price: @cost.price, user_id: @cost.user_id } }
    end
  ...
  test "should update cost" do
    patch cost_url(@cost), params: { cost: { description: @cost.description, price: @cost.price, user_id: @cost.user_id } }
